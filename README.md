...
- **postX.rda**: These are the extracted posterior distributions from each model. Numbers reflect model numbers from 2_models.R
- **WAIC.rda**: These are the WAIC values for the main models in the text
- **TAX.rda**: These are the model estimates. Numbers reflect model numbers from 2_models.R
